...
async def main():
    ...
    messages = [
        SystemMessage(content=(
            "Bạn là chuyên gia pháp lý. Ưu tiên dùng tools để tra cứu, "
            "trả lời ngắn gọn, rõ ràng, và chỉ kết luận theo dữ liệu từ tool. "
            "Nếu dữ liệu không đủ thì nói là chưa đủ thông tin."
        )),
